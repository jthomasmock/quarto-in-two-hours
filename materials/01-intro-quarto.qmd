...
-   Batteries included (it's installed WITH latest version of RStudio)
-   Better ability to integrate multiple languages in a PROJECT and evaluate code in native language (R in knitr, Python/Julia in Jupyter)
